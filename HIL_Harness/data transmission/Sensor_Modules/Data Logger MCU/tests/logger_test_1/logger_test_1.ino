...
Data logging MCU  - Test 1 =====================================================================

This MCU receives and displays a constant array[5] of 1's.
...
COMPILE:
arduino-cli compile --fqbn arduino:avr:uno logger_test_1.ino

arduino-cli upload -p /dev/cu.usbmodem1101 --fqbn arduino:avr:uno logger_test_1.ino -v
